package com.fulfai.partner.security;

import java.security.Principal;

import com.fulfai.common.security.CognitoUtils;
import com.fulfai.common.security.LambdaIdentityProvider;
...
@ApplicationScoped
public class PartnerSecurityProvider implements LambdaIdentityProvider {
    ...
    public SecurityIdentity authenticate(AwsProxyRequest event, AuthenticationRequestContext context) {
        ...
        // Example: builder.addRole("partner");
