...
public class Schemas {
    ...
    public static final TableSchema<Order> ORDER_SCHEMA = TableSchema.builder(Order.class)
            ...
            .addAttribute(String.class, a -> a.name("orderId")
                    ...
                    .tags(StaticAttributeTags.primarySortKey()))
            .addAttribute(String.class, a -> a.name("orderDate")
            ...
            .addAttribute(String.class, a -> a.name("customerName")
                    .getter(Order::getCustomerName)
                    .setter(Order::setCustomerName))
            .addAttribute(String.class, a -> a.name("customerPhone")
                    .getter(Order::getCustomerPhone)
                    .setter(Order::setCustomerPhone))
            .addAttribute(String.class, a -> a.name("customerEmail")
                    .getter(Order::getCustomerEmail)
                    .setter(Order::setCustomerEmail))
            .addAttribute(String.class, a -> a.name("shippingAddress")
                    .getter(Order::getShippingAddress)
                    .setter(Order::setShippingAddress))
            .addAttribute(String.class, a -> a.name("branchId")
