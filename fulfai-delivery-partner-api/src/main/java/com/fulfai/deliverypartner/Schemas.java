...
public class Schemas {
    ...
    public static final TableSchema<DriverOrderAssignment> ASSIGNMENT_SCHEMA = TableSchema.builder(DriverOrderAssignment.class)
            ...
            .addAttribute(String.class, a -> a.name("orderId")
                    ...
                    .tags(StaticAttributeTags.secondaryPartitionKey(DriverOrderAssignment.ORDER_GSI)))
            ...
            .addAttribute(String.class, a -> a.name("status")
                    ...
                    .tags(StaticAttributeTags.secondaryPartitionKey(DriverOrderAssignment.STATUS_GSI)))
    ...
    public static final TableSchema<DriverLocation> LOCATION_SCHEMA = TableSchema.builder(DriverLocation.class)
            ...
            .addAttribute(Instant.class, a -> a.name("timestamp")
                    ...
                    .tags(StaticAttributeTags.primarySortKey(),
                            StaticAttributeTags.secondarySortKey(DriverLocation.GEOHASH_GSI)))
